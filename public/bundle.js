...
var api = __webpack_require__(/*! ../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../../css-loader/dist/cjs.js!./material_green.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/material_green.css");
...
/* harmony import */ var flatpickr_dist_themes_material_green_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! flatpickr/dist/themes/material_green.css */ "./node_modules/flatpickr/dist/themes/material_green.css");
/* harmony import */ var flatpickr_dist_themes_material_green_css__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_themes_material_green_css__WEBPACK_IMPORTED_MODULE_7__);
...
const createNewTaskTemplate = (task, options = {}) => {
  ...
  const isBlockSaveButton = (isDateShowing && isRepeatingTask) || (isRepeatingTask && !Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["isRepeating"])(activeRepeatingDays)) || !isAllowableDescriptionLength(description);

  const date = (isDateShowing && dueDate) ? `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(dueDate)}` : ``;
...
const parseFormData = (formData) => {
  const repeatingDays = _const_js__WEBPACK_IMPORTED_MODULE_1__["DAYS"].reduce((acc, day) => {
    acc[day] = false;
    return acc;
  }, {});
...
class NewTask extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  ...
  _applyFlatpickr() {
    ...
    if (this._isDateShowing) {
      ...
      this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(dateElement, {
        altInput: true,
        allowInput: true,
...
const createTaskTemplate = (task) => {
  ...
  const date = isDataShowind ? `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(dueDate)}` : ``;
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: FILTER_NAMES, DAYS, Color, COLORS, DESCRIPTIONS, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class BoardController {
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(container, this._sortComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(container, this._tasksComponent);
  ...
  createTask() {
    ...
    this._creatingTask = new _task_js__WEBPACK_IMPORTED_MODULE_5__["default"](taskListElement, this._dataChangeHandler, this._viewChangeHandler);
  ...
  _dataChangeHandler(oldData, newData) {
    if (oldData === _task_js__WEBPACK_IMPORTED_MODULE_5__["EmptyTask"]) {
      ...
      this._tasksModel.removeTasks(newData.id);
      this._updateTasks();
    } else {
...
class Filter {
  ...
  render() {
    ...
    this._siteFilterComponent = new _components_site_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters);
    this._siteFilterComponent.setFilterChangeHandler(this._filterChangehandler);

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._siteFilterComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._siteFilterComponent);
    }
  }
...
const EmptyTask = {
  ...
  color: _const_js__WEBPACK_IMPORTED_MODULE_3__["default"].BLACK,
  isFavorite: false,
  isArchive: false,
};
...
class TaskController {
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldNewTaskComponent && oldTaskComponent) {
          ...
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._taskEditComponent, oldNewTaskComponent);
      ...
      case Mode.ADDING:
        if (oldNewTaskComponent && oldTaskComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldTaskComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldNewTaskComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._taskEditComponent, true);
        break;
    }
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._newTaskComponent);
...
/* harmony import */ var _controllers_filter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/filter.js */ "./src/controllers/filter.js");
...
/* harmony import */ var _models_tasks_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/tasks.js */ "./src/models/tasks.js");
...
const tasksModel = new _models_tasks_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
tasksModel.setTasks(tasks);

const menuComponent = new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(siteHeaderElement, menuComponent);

const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"](siteMainElement, tasksModel);
...
const boardController = new _controllers_board_js__WEBPACK_IMPORTED_MODULE_2__["default"](boardComponent, tasksModel);
boardController.render();

menuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"].NEW_TASK:
      menuComponent.setActiveItem(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"].TASKS);
...
class Tasks {
  ...
  getTasks() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getTasksByFilter"])(this._tasks, this._activeFilter);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatTime, formatDate, getRandomIntegerNumber, getRandomElementFromArray, getRandomDate, createElement, isRepeating, isOverdueDate, isOneDay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
